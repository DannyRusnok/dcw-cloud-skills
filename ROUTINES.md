...
| weekly CEO report | `weekly-ceo-report/SKILL.md` | NE 08:00 CET | NOTIFY_KEY (jen fallback) | article-forge, substack-mcp (grownote), drippery-mcp, mem0, dcw-context-hub, gumroad-mcp (revenue sekce; bez connectoru se sekce vynechá) |
