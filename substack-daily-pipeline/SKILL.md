...
### 4. Fact-check gate (HARD — žádné vymyšlené číslo)
**Pravidlo:** každé číslo, název nástroje, doba trvání, milestone nebo konkrétní tvrzení v notě (vč. čísel v `imageSpec`) MUSÍ mít **verified zdroj**. Nikdy nevymýšlej číslo jen aby note vypadala "specifická" — radši kvalitativní formulace než halucinovaný stat.
